    ...
    <div class="w-full" style="padding: 2rem; padding-left: 18rem;">
        <div class="bg-white p-6 rounded-lg shadow-md flex flex-col gap-3">
            <div class="flex justify-between items-center">
                <h1 class="font-bold" style="font-size: 20px;">Klasifikasi</h1>
                <a href="{{ route('dashboard.klasifikasi.create') }}" type="button"
                                ...
                                @foreach ($klasifikasi as $index => $item)
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-end text-sm font-medium flex justify-center gap-2">
                                            <a href="{{ route('dashboard.klasifikasi.edit', ['klasifikasi' => $item->id]) }}" type="button"
                                            ...
                                            <a href="{{ route('dashboard.klasifikasi.destroy', $item->id) }}" data-confirm-delete="true" type="button"
